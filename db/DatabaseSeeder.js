  ...
  mediaArray.push(
    {
      ...
      created_time: moment().utcOffset(7).hour(0).minute(0).second(0).subtract(4, 'days').unix(),
    },
    {
      id: "1516059927444791289_1945373804",
      created_time: moment().utcOffset(7).hour(0).minute(0).second(0).subtract(3, 'days').unix(),
    },
    {
      id: "1007765561032799472_1945373804",
      created_time: moment().utcOffset(7).hour(0).minute(0).second(0).subtract(2, 'days').unix(),
    },
    {
      id: "1007748652140820479_1945373804",
      created_time: moment().utcOffset(7).hour(0).minute(0).second(0).subtract(1, 'days').unix(),
    },
    {
      id: "1007719002664564269_1945373804",
      created_time: moment().utcOffset(7).hour(0).minute(0).second(0).subtract(0, 'days').unix(),
    }
  );
